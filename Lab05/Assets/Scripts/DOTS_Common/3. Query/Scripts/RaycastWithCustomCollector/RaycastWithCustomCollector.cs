...
public partial struct RaycastWithCustomCollectorSystem : ISystem
{
    ...
    struct ComponentHandles
    {
        ...
        public ComponentLookup<PostTransformMatrix> PostTransformMatrixs;
#else
        ...
        public ComponentHandles(ref SystemState state)
        {
            ...
            PostTransformMatrixs = state.GetComponentLookup<PostTransformMatrix>(false);
#else
        ...
        public void Update(ref SystemState state)
        {
            ...
            PostTransformMatrixs.Update(ref state);
#else
    ...
    public partial struct RaycastWithCustomCollectorJob : IJobEntity
    {
        ...
        public void Execute(Entity entity, ref Rotation rotation, ref VisualizedRaycast visualizedRaycast)
        {
            ...
            PostTransformMatrixs[visualizedRaycast.HitRayEntity] = new PostTransformMatrix { Value = float4x4.Scale(newHitRayScale) };
            ...
            PostTransformMatrixs[visualizedRaycast.FullRayEntity] = new PostTransformMatrix { Value = float4x4.Scale(newFullRayScale) };
#else
    ...
    public void OnUpdate(ref SystemState state)
    {
        ...
        var raycastJob = new RaycastWithCustomCollectorJob
        {
            ...
            PostTransformMatrixs = m_Handles.PostTransformMatrixs,
#else
